...
getwd() # Run this line to see where R gets its files from. If this folder is not the one where you have saved your data, you can use 

setwd() # to set the right folder.
...
site_colors <- c("Bruksgräsmatta" = "#9F2B68", # Set colours for the plots that are made lateron

...
descr_full_df_C <- ddply(descr_data_full, ~ Treatment*Timing, summarise, 
                       ...
                       MeanW_positiveattitude = mean(W_positiveattitude), 
                       SEW_positiveattitude = sd(W_positiveattitude)/sqrt(length(W_positiveattitude)), 
                       ...
                       MeanW_supportactions = mean(W_supportactions), 
                       SEW_supportactions = sd(W_supportactions)/sqrt(length(W_supportactions)))
descr_full_df_W
```
